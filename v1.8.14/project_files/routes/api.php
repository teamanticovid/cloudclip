...
Route::group(['middleware' => ['auth:api', 'auth.shared', 'scope:visitor,editor']], function () {
    ...
    Route::post('/zip/private', 'FileFunctions\EditItemsController@user_zip_multiple_files');
    Route::get('/zip-folder/{unique_id}/private', 'FileFunctions\EditItemsController@user_zip_folder');
});
